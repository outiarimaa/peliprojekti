...
CREATE TABLE `kysymysvaihtoehdot` (
  ...
  `oikeavastaus` varchar(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `kysymysvaihtoehdot` VALUES (2,'Tiedoston sulkeminen kannattaa tehdä try-lohkon sisällä','T'),(3,'LinkedListin avulla voi hakea nopeasti tallennetuja arvoja','T'),(4,'Collection on rajapinta ja Collections on luokka','T');
...
-- Dump completed on 2018-02-22 15:20:13
